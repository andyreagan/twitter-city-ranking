...
if __name__ == '__main__':
    ...
    for keyword in keyWords:
        ...
        while currDay <= end:
            ...
            print "reading keywords/{0}/tweets/{1}-frequency-{2}.csv".format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,)
            f = codecs.open('keywords/{0}/tweets/{1}-frequency-{2}.csv'.format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,),'r','utf8')
            for i in xrange(24):
            ...
            print dayfreqarray
            print "writing keywords/{0}/tweets/{1}-frequency-{2}-sum.csv".format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,)
            f = codecs.open('keywords/{0}/tweets/{1}-frequency-{2}-sum.csv'.format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,),'w','utf8')
            f.write('{0:.0f}'.format(dayfreqarray))
            f.close()

            # read in the word vectors
            print 'reading keywords/{0}/tweets/{1}-word-vector-{2}.csv'.format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,)
            f = codecs.open('keywords/{0}/tweets/{1}-word-vector-{2}.csv'.format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,),'r','utf8')
            for i in xrange(24):
            ...
            print 'writing keywords/{0}/tweets/{1}-word-vector-{2}-sum.csv'.format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,)
            f = codecs.open('keywords/{0}/tweets/{1}-word-vector-{2}-sum.csv'.format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,),'w','utf8')
            ...
            print "writing keywords/{0}/tweets/{1}-happs-{2}-sum.csv".format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,)
            f = codecs.open('keywords/{0}/tweets/{1}-happs-{2}-sum.csv'.format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,),'w','utf8')
            ...
            # write out the day happs
            print "writing keywords/{0}/tweets/{1}-happs-{2}.csv".format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,)
            f = codecs.open('keywords/{0}/tweets/{1}-happs-{2}.csv'.format(folderNames[wordCount],currDay.strftime('%d.%m.%y'),wordCount,),'w','utf8')
            for i in xrange(24):
